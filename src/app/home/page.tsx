      ...
      <div className="w-full p-4 md:p-8">
        ...
        <div className="flex overflow-x-auto space-x-4 scrollbar-hide">
          <div className="bg-[#123456] rounded-lg p-4 shadow-md w-64 flex-shrink-0 flex flex-col">
            ...
            <a href='https://www.sciencefocus.com/space/what-is-rocket-science' className="mt-auto px-4 py-2 bg-[#0a2540] text-white rounded-lg w-full text-center hover:text-blue-600 transition duration-300">READ</a>
          </div>
          <div className="bg-[#123456] rounded-lg p-4 shadow-md w-64 flex-shrink-0 flex flex-col">
            <div className="flex items-start">
            ...
            <a href='https://www.space.com/26218-astrophysics.html' className="mt-auto px-4 py-2 bg-[#0a2540] text-white rounded-lg w-full text-center hover:text-blue-600 transition duration-300">READ</a>
          </div>
          <div className="bg-[#123456] rounded-lg p-4 shadow-md w-64 flex-shrink-0 flex flex-col">
            <div className="flex items-start">
            ...
            <a href='https://www.techtarget.com/searchenterpriseai/definition/AI-Artificial-Intelligence' className="mt-auto px-4 py-2 bg-[#0a2540] text-white rounded-lg w-full text-center hover:text-blue-600 transition duration-300">READ</a>
          </div>
          <div className="bg-[#123456] rounded-lg p-4 shadow-md w-64 flex-shrink-0 flex flex-col">
            <div className="flex items-start">
            ...
            <a href='https://aws.amazon.com/what-is/quantum-computing/#:~:text=Quantum%20computing%20is%20a%20multidisciplinary,faster%20than%20on%20classical%20computers.' className="mt-auto px-4 py-2 bg-[#0a2540] text-white rounded-lg w-full text-center hover:text-blue-600 transition duration-300">READ</a>
          </div>
          <div className="bg-[#123456] rounded-lg p-4 shadow-md w-64 flex-shrink-0 flex flex-col">
            <div className="flex items-start">
            ...
            <a href='https://www.simplilearn.com/tutorials/data-science-tutorial/what-is-data-science' className="mt-auto px-4 py-2 bg-[#0a2540] text-white rounded-lg w-full text-center hover:text-blue-600 transition duration-300">READ</a>
          </div>
          <div className="bg-[#123456] rounded-lg p-4 shadow-md w-64 flex-shrink-0 flex flex-col">
            <div className="flex items-start">
            ...
            <a href='https://www.cisco.com/site/us/en/learn/topics/security/what-is-cybersecurity.html' className="mt-auto px-4 py-2 bg-[#0a2540] text-white rounded-lg w-full text-center hover:text-blue-600 transition duration-300">READ</a>
          </div>
        </div>
      </div>
    </main>
